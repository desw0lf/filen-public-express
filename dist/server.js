...
import { defaultPort, defaultCorsOptions, defaultConfig, defaultLoggerOptions } from "./consts.js";
...
export class FilenPublicExpress {
    ...
    constructor({ hostname = "0.0.0.0", port = defaultPort, user, https = false, rateLimit = {
        ...
        GetObject: true,
        // HeadObject: true
    }, logger: { instance, ...customLoggerOptions } = {}, config = {}, corsOptions = defaultCorsOptions }) {
    ...
    initializeRoutes(enabled, corsOptions, disableLogging) {
        this.connections = {};
